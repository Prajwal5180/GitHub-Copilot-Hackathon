...
1. **Utilize Github Copilot Workspace to create a new app named Expense Tracker:**
   ...
   - Run the application in your local system successfully. The application should be similar to the below example:
...
1. **Utilize the capabilities of File referencing:**
   ...
   - Provide some prompts that require Github Copilot to reference multiple files in your multi-file project, and analyze the refrences properly, i.e. provide such prompts that tell the uses of **index.js** file in the **Expense Tracker** application you built earlier.

   - Provide such a prompt using file references which integrates **Date** field in **ExpenseForm** document in your **Expense tracker application** and display it in **ExpenseItem** and then, will be able to sort the expenses by date in the **ExpenseList** component.

      The output should be similar to given below:
...
- Verify that the Date component is added in your application and working properly.
